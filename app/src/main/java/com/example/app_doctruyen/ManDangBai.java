...
public class ManDangBai extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnXoaBai.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int truyenId = getIntent().getIntExtra("Id", 0);
                databasedoctruyen.Delete(truyenId);
                Toast.makeText(ManDangBai.this, "Đã xóa bài thành công", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
